                ...
                <div class="card-body">
                    <form class="needs-validation" action="Controlador?menu=Clientes" method="POST" novalidate>
                        ...
                        <div class="form-group" >
                            ...
                            <input  type="text" name="txtDireccion" value="${clienteEdit.direccionCliente}" 
                        ...
                        <div class="form-group" >
                            <label>Correo</label>
                            <input  type="email" name="txtCorreo" value="${clienteEdit.correoCliente}" 
                                    class="form-control" required="">
                            <div class="valid-feedback">Campo OK</div>
                            <div class="invalid-feedback">Complete los datos</div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <input  type="text" name="txtTelefono" value="${clienteEdit.telefonoCliente}" 
                                    class="form-control" required="">
                            <div class="valid-feedback">Campo OK</div>
                            <div class="invalid-feedback">Complete los datos</div>
                        </div>
